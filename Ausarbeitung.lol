...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5}Kompilierung eines Modells}{35}{lstlisting.5}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {6}Logging Funktion für Trainingsvorgänge}{35}{lstlisting.6}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {7}Start des Trainings mit Keras}{36}{lstlisting.7}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8}Auswertung eines Modells mit Testdaten}{36}{lstlisting.8}
\defcounter {refsection}{0}\relax 
...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {12}Laden der frontendseitigen MediaPipe Hands Modelle.}{47}{lstlisting.12}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {13}Erkennen einer Hand mit MediaPipe Hands.}{48}{lstlisting.13}
